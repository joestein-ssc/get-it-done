...
<required_reading>
@~/.claude/get-it-done/references/verification-patterns.md
@~/.claude/get-it-done/templates/verification-report.md
</required_reading>
...
Use gid-tools to extract must_haves from each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node ~/.claude/get-it-done/bin/gid-tools.js frontmatter get "$plan" --field must_haves)
...
Use gid-tools for artifact verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node ~/.claude/get-it-done/bin/gid-tools.js verify artifacts "$plan")
...
Use gid-tools for key link verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node ~/.claude/get-it-done/bin/gid-tools.js verify key-links "$plan")
...
See ~/.claude/get-it-done/templates/verification-report.md for complete template.
</step>
