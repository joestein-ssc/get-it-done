...
```bash
node ~/.claude/get-it-done/bin/gid-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase}-UAT.md"
```
</step>
