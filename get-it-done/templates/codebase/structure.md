...
│   └── gid/           # GID-specific commands
├── get-it-done/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/gid/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-it-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-it-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-it-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-it-done/references/{name}.md`
