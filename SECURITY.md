...
Instead, please report them via email to: **security@gid.build** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the GID codebase that could:
